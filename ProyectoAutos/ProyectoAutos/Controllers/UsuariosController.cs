...
namespace ProyectoAutos.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="idUsuario,nombreUsuario,user,email,password,idRol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="idUsuario,nombreUsuario,user,email,password,idRol")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
